...
{
    return [[ShotgunDate alloc] initWithTimeIntervalSince1970:[date timeIntervalSince1970]];    
}
...
{
    return [[ShotgunDateTime alloc] initWithTimeIntervalSince1970:[date timeIntervalSince1970]];    
}
